...
//go:generate go run github.com/crossplane/upjet/cmd/resolver -g keycloak.crossplane.io -a github.com/crossplane-contrib/provider-keycloak/internal/apis -s
