...
func (tr *ImporterIdentityProviderMapper) GetObservation() (map[string]any, error) {
...
func (tr *ImporterIdentityProviderMapper) SetObservation(obs map[string]any) error {
...
func (tr *ImporterIdentityProviderMapper) GetParameters() (map[string]any, error) {
...
func (tr *ImporterIdentityProviderMapper) SetParameters(params map[string]any) error {
...
// GetInitParameters of this ImporterIdentityProviderMapper
func (tr *ImporterIdentityProviderMapper) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this ImporterIdentityProviderMapper
func (tr *ImporterIdentityProviderMapper) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
