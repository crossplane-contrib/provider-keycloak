...
type ExecutionConfigInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/crossplane-contrib/provider-keycloak/apis/namespaced/authenticationflow/v1alpha1.Execution
	...
	ExecutionIDRef *v1.NamespacedReference `json:"executionIdRef,omitempty" tf:"-"`

	// Selector for a Execution in authenticationflow to populate executionId.
	// +kubebuilder:validation:Optional
	ExecutionIDSelector *v1.NamespacedSelector `json:"executionIdSelector,omitempty" tf:"-"`
