...
func (mg *Bindings) ResolveReferences( // ResolveReferences of this Bindings.
...
func (mg *ExecutionConfig) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	var err error
	{
		m, l, err = apisresolver.GetManagedResource("authenticationflow.keycloak.m.crossplane.io", "v1alpha1", "Execution", "ExecutionList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
