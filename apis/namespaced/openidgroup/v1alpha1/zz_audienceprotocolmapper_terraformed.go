...
func (tr *AudienceProtocolMapper) GetObservation() (map[string]any, error) {
...
func (tr *AudienceProtocolMapper) SetObservation(obs map[string]any) error {
...
func (tr *AudienceProtocolMapper) GetParameters() (map[string]any, error) {
...
func (tr *AudienceProtocolMapper) SetParameters(params map[string]any) error {
...
// GetInitParameters of this AudienceProtocolMapper
func (tr *AudienceProtocolMapper) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this AudienceProtocolMapper
func (tr *AudienceProtocolMapper) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
