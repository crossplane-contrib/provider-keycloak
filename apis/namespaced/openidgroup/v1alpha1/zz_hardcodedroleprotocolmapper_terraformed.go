...
func (tr *HardcodedRoleProtocolMapper) GetObservation() (map[string]any, error) {
...
func (tr *HardcodedRoleProtocolMapper) SetObservation(obs map[string]any) error {
...
func (tr *HardcodedRoleProtocolMapper) GetParameters() (map[string]any, error) {
...
func (tr *HardcodedRoleProtocolMapper) SetParameters(params map[string]any) error {
...
// GetInitParameters of this HardcodedRoleProtocolMapper
func (tr *HardcodedRoleProtocolMapper) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this HardcodedRoleProtocolMapper
func (tr *HardcodedRoleProtocolMapper) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
