...
func (mg *AudienceProtocolMapper) ResolveReferences( // ResolveReferences of this AudienceProtocolMapper.
...
// ResolveReferences of this AudienceResolveProtocolMapper.
func (mg *AudienceResolveProtocolMapper) ResolveReferences(ctx context.Context, c client.Reader) error {
	var m xpresource.Managed
	var l xpresource.ManagedList
	r := reference.NewAPINamespacedResolver(c, mg)
...
// ResolveReferences of this FullNameProtocolMapper.
func (mg *FullNameProtocolMapper) ResolveReferences(ctx context.Context, c client.Reader) error {
	var m xpresource.Managed
	var l xpresource.ManagedList
	r := reference.NewAPINamespacedResolver(c, mg)
...
// ResolveReferences of this HardcodedClaimProtocolMapper.
func (mg *HardcodedClaimProtocolMapper) ResolveReferences(ctx context.Context, c client.Reader) error {
	var m xpresource.Managed
	var l xpresource.ManagedList
	r := reference.NewAPINamespacedResolver(c, mg)
...
// ResolveReferences of this HardcodedRoleProtocolMapper.
func (mg *HardcodedRoleProtocolMapper) ResolveReferences(ctx context.Context, c client.Reader) error {
	var m xpresource.Managed
	var l xpresource.ManagedList
	r := reference.NewAPINamespacedResolver(c, mg)
...
// ResolveReferences of this SubProtocolMapper.
func (mg *SubProtocolMapper) ResolveReferences(ctx context.Context, c client.Reader) error {
	var m xpresource.Managed
	var l xpresource.ManagedList
	r := reference.NewAPINamespacedResolver(c, mg)
...
// ResolveReferences of this UserClientRoleProtocolMapper.
func (mg *UserClientRoleProtocolMapper) ResolveReferences(ctx context.Context, c client.Reader) error {
	var m xpresource.Managed
	var l xpresource.ManagedList
	r := reference.NewAPINamespacedResolver(c, mg)
	...
	mg.Spec.ForProvider.ClientIDRef = rsp.ResolvedReference
	{
		...
		rsp, err = r.Resolve(ctx, reference.NamespacedResolutionRequest{
			CurrentValue: reference.FromPtrValue(mg.Spec.ForProvider.ClientIDForRoleMappings),
			Extract:      common.UUIDExtractor(),
			Namespace:    mg.GetNamespace(),
			Reference:    mg.Spec.ForProvider.ClientIDForRoleMappingsRef,
			Selector:     mg.Spec.ForProvider.ClientIDForRoleMappingsSelector,
			To:           reference.To{List: l, Managed: m},
		})
	}
	if err != nil {
		return errors.Wrap(err, "mg.Spec.ForProvider.ClientIDForRoleMappings")
	}
	mg.Spec.ForProvider.ClientIDForRoleMappings = reference.ToPtrValue(rsp.ResolvedValue)
	mg.Spec.ForProvider.ClientIDForRoleMappingsRef = rsp.ResolvedReference
	{
		m, l, err = apisresolver.GetManagedResource("openidclient.keycloak.m.crossplane.io", "v1alpha1", "ClientScope", "ClientScopeList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
	...
	mg.Spec.InitProvider.ClientIDRef = rsp.ResolvedReference
	{
		...
		rsp, err = r.Resolve(ctx, reference.NamespacedResolutionRequest{
			CurrentValue: reference.FromPtrValue(mg.Spec.InitProvider.ClientIDForRoleMappings),
			Extract:      common.UUIDExtractor(),
			Namespace:    mg.GetNamespace(),
			Reference:    mg.Spec.InitProvider.ClientIDForRoleMappingsRef,
			Selector:     mg.Spec.InitProvider.ClientIDForRoleMappingsSelector,
			To:           reference.To{List: l, Managed: m},
		})
	}
	if err != nil {
		return errors.Wrap(err, "mg.Spec.InitProvider.ClientIDForRoleMappings")
	}
	mg.Spec.InitProvider.ClientIDForRoleMappings = reference.ToPtrValue(rsp.ResolvedValue)
	mg.Spec.InitProvider.ClientIDForRoleMappingsRef = rsp.ResolvedReference
	{
		m, l, err = apisresolver.GetManagedResource("openidclient.keycloak.m.crossplane.io", "v1alpha1", "ClientScope", "ClientScopeList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
...
// ResolveReferences of this UserRealmRoleProtocolMapper.
func (mg *UserRealmRoleProtocolMapper) ResolveReferences(ctx context.Context, c client.Reader) error {
	var m xpresource.Managed
	var l xpresource.ManagedList
	r := reference.NewAPINamespacedResolver(c, mg)
...
// ResolveReferences of this UserSessionNoteProtocolMapper.
func (mg *UserSessionNoteProtocolMapper) ResolveReferences(ctx context.Context, c client.Reader) error {
	var m xpresource.Managed
	var l xpresource.ManagedList
	r := reference.NewAPINamespacedResolver(c, mg)
