...
func (in *ProtocolMapperInitParameters) DeepCopyInto(out *ProtocolMapperInitParameters) {
	*out = *in
	...
	if in.OidcClientIDRef != nil {
		in, out := &in.OidcClientIDRef, &out.OidcClientIDRef
		*out = new(v1.NamespacedReference)
		(*in).DeepCopyInto(*out)
	}
	if in.OidcClientIDSelector != nil {
		in, out := &in.OidcClientIDSelector, &out.OidcClientIDSelector
		*out = new(v1.NamespacedSelector)
		(*in).DeepCopyInto(*out)
	}
	if in.OidcClientScopeID != nil {
		in, out := &in.OidcClientScopeID, &out.OidcClientScopeID
		*out = new(string)
		**out = **in
	}
	if in.OidcClientScopeIDRef != nil {
		in, out := &in.OidcClientScopeIDRef, &out.OidcClientScopeIDRef
		*out = new(v1.NamespacedReference)
		(*in).DeepCopyInto(*out)
	}
	if in.OidcClientScopeIDSelector != nil {
		in, out := &in.OidcClientScopeIDSelector, &out.OidcClientScopeIDSelector
		*out = new(v1.NamespacedSelector)
		(*in).DeepCopyInto(*out)
	}
	if in.Protocol != nil {
