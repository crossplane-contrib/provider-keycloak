...
type AuthenticationFlowBindingOverridesInitParameters struct {
	...
	BrowserIDRef *v1.NamespacedReference `json:"browserIdRef,omitempty" tf:"-"`

	// Selector for a Flow in authenticationflow to populate browserId.
	// +kubebuilder:validation:Optional
	BrowserIDSelector *v1.NamespacedSelector `json:"browserIdSelector,omitempty" tf:"-"`
	...
	// +kubebuilder:validation:Optional
	DirectGrantIDRef *v1.NamespacedReference `json:"directGrantIdRef,omitempty" tf:"-"`

	// Selector for a Flow in authenticationflow to populate directGrantId.
	// +kubebuilder:validation:Optional
	DirectGrantIDSelector *v1.NamespacedSelector `json:"directGrantIdSelector,omitempty" tf:"-"`
}
...
type ClientInitParameters struct {
	...
	// +mapType=granular
	ClientSecretRegenerateWhenChanged map[string]*string `json:"clientSecretRegenerateWhenChanged,omitempty" tf:"client_secret_regenerate_when_changed,omitempty"`
