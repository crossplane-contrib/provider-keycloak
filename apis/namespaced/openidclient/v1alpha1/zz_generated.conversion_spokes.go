...
// ConvertTo converts this Client to the hub type.
func (tr *Client) ConvertTo(dstRaw conversion.Hub) error {
...
// ConvertFrom converts from the hub type to the Client type.
func (tr *Client) ConvertFrom(srcRaw conversion.Hub) error {
	spokeVersion := tr.GetObjectKind().GroupVersionKind().Version
