...
// ResolveReferences of this ClientAdminPermissions.
func (mg *ClientAdminPermissions) ResolveReferences(ctx context.Context, c client.Reader) error {
	var m xpresource.Managed
	var l xpresource.ManagedList
	r := reference.NewAPINamespacedResolver(c, mg)
	...
	mg.Spec.ForProvider.AggregatePoliciesRefs = mrsp.ResolvedReferences
	{
		...
		mrsp, err = r.ResolveMultiple(ctx, reference.MultiNamespacedResolutionRequest{
			CurrentValues: reference.FromPtrValues(mg.Spec.ForProvider.ClientIds),
			Extract:       common.UUIDExtractor(),
			Namespace:     mg.GetNamespace(),
			References:    mg.Spec.ForProvider.ClientIdsRefs,
			Selector:      mg.Spec.ForProvider.ClientIdsSelector,
			To:            reference.To{List: l, Managed: m},
		})
	}
	if err != nil {
		return errors.Wrap(err, "mg.Spec.ForProvider.ClientIds")
	}
	mg.Spec.ForProvider.ClientIds = reference.ToPtrValues(mrsp.ResolvedValues)
	mg.Spec.ForProvider.ClientIdsRefs = mrsp.ResolvedReferences
	{
	...
	mg.Spec.ForProvider.RolePoliciesRefs = mrsp.ResolvedReferences
	{
		...
		mrsp, err = r.ResolveMultiple(ctx, reference.MultiNamespacedResolutionRequest{
			CurrentValues: reference.FromPtrValues(mg.Spec.ForProvider.SAMLClientIds),
			Extract:       common.UUIDExtractor(),
			Namespace:     mg.GetNamespace(),
			References:    mg.Spec.ForProvider.SAMLClientIdsRefs,
			Selector:      mg.Spec.ForProvider.SAMLClientIdsSelector,
			To:            reference.To{List: l, Managed: m},
		})
	}
	if err != nil {
		return errors.Wrap(err, "mg.Spec.ForProvider.SAMLClientIds")
	}
	mg.Spec.ForProvider.SAMLClientIds = reference.ToPtrValues(mrsp.ResolvedValues)
	mg.Spec.ForProvider.SAMLClientIdsRefs = mrsp.ResolvedReferences
	{
	...
	mg.Spec.InitProvider.AggregatePoliciesRefs = mrsp.ResolvedReferences
	{
		...
		mrsp, err = r.ResolveMultiple(ctx, reference.MultiNamespacedResolutionRequest{
			CurrentValues: reference.FromPtrValues(mg.Spec.InitProvider.ClientIds),
			Extract:       common.UUIDExtractor(),
			Namespace:     mg.GetNamespace(),
			References:    mg.Spec.InitProvider.ClientIdsRefs,
			Selector:      mg.Spec.InitProvider.ClientIdsSelector,
			To:            reference.To{List: l, Managed: m},
		})
	}
	if err != nil {
		return errors.Wrap(err, "mg.Spec.InitProvider.ClientIds")
	}
	mg.Spec.InitProvider.ClientIds = reference.ToPtrValues(mrsp.ResolvedValues)
	mg.Spec.InitProvider.ClientIdsRefs = mrsp.ResolvedReferences
	{
		m, l, err = apisresolver.GetManagedResource("openidclient.keycloak.m.crossplane.io", "v1alpha1", "ClientClientPolicy", "ClientClientPolicyList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
	...
	mg.Spec.InitProvider.RolePoliciesRefs = mrsp.ResolvedReferences
	{
		...
		mrsp, err = r.ResolveMultiple(ctx, reference.MultiNamespacedResolutionRequest{
			CurrentValues: reference.FromPtrValues(mg.Spec.InitProvider.SAMLClientIds),
			Extract:       common.UUIDExtractor(),
			Namespace:     mg.GetNamespace(),
			References:    mg.Spec.InitProvider.SAMLClientIdsRefs,
			Selector:      mg.Spec.InitProvider.SAMLClientIdsSelector,
			To:            reference.To{List: l, Managed: m},
		})
	}
	if err != nil {
		return errors.Wrap(err, "mg.Spec.InitProvider.SAMLClientIds")
	}
	mg.Spec.InitProvider.SAMLClientIds = reference.ToPtrValues(mrsp.ResolvedValues)
	mg.Spec.InitProvider.SAMLClientIdsRefs = mrsp.ResolvedReferences
	{
		m, l, err = apisresolver.GetManagedResource("openidclient.keycloak.m.crossplane.io", "v1alpha1", "ClientTimePolicy", "ClientTimePolicyList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
...
// ResolveReferences of this ClientAuthorizationClientScopePolicy.
func (mg *ClientAuthorizationClientScopePolicy) ResolveReferences(ctx context.Context, c client.Reader) error {
	var m xpresource.Managed
	var l xpresource.ManagedList
	r := reference.NewAPINamespacedResolver(c, mg)
	...
	for i3 := 0; i3 < len(mg.Spec.ForProvider.Scope); i3++ {
		{
			...
			rsp, err = r.Resolve(ctx, reference.NamespacedResolutionRequest{
				CurrentValue: reference.FromPtrValue(mg.Spec.ForProvider.Scope[i3].ID),
				Extract:      common.UUIDExtractor(),
				Namespace:    mg.GetNamespace(),
				Reference:    mg.Spec.ForProvider.Scope[i3].IDRef,
				Selector:     mg.Spec.ForProvider.Scope[i3].IDSelector,
				To:           reference.To{List: l, Managed: m},
			})
		}
		if err != nil {
			return errors.Wrap(err, "mg.Spec.ForProvider.Scope[i3].ID")
		}
		mg.Spec.ForProvider.Scope[i3].ID = reference.ToPtrValue(rsp.ResolvedValue)
		mg.Spec.ForProvider.Scope[i3].IDRef = rsp.ResolvedReference
	...
	for i3 := 0; i3 < len(mg.Spec.InitProvider.Scope); i3++ {
		{
			...
			rsp, err = r.Resolve(ctx, reference.NamespacedResolutionRequest{
				CurrentValue: reference.FromPtrValue(mg.Spec.InitProvider.Scope[i3].ID),
				Extract:      common.UUIDExtractor(),
				Namespace:    mg.GetNamespace(),
				Reference:    mg.Spec.InitProvider.Scope[i3].IDRef,
				Selector:     mg.Spec.InitProvider.Scope[i3].IDSelector,
				To:           reference.To{List: l, Managed: m},
			})
		}
		if err != nil {
			return errors.Wrap(err, "mg.Spec.InitProvider.Scope[i3].ID")
		}
		mg.Spec.InitProvider.Scope[i3].ID = reference.ToPtrValue(rsp.ResolvedValue)
		mg.Spec.InitProvider.Scope[i3].IDRef = rsp.ResolvedReference
...
func (mg *ClientAuthorizationPermission) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	mg.Spec.ForProvider.ResourceServerIDRef = rsp.ResolvedReference
	{
		m, l, err = apisresolver.GetManagedResource("openidclient.keycloak.m.crossplane.io", "v1alpha1", "ClientAuthorizationResource", "ClientAuthorizationResourceList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
...
// ResolveReferences of this ClientRegexPolicy.
func (mg *ClientRegexPolicy) ResolveReferences(ctx context.Context, c client.Reader) error {
	var m xpresource.Managed
	var l xpresource.ManagedList
	r := reference.NewAPINamespacedResolver(c, mg)
