...
type ClientAdminPermissionsInitParameters struct {
	...
	// +crossplane:generate:reference:extractor=github.com/crossplane-contrib/provider-keycloak/config/common.UUIDExtractor()
	// +listType=set
	SAMLClientIds []*string `json:"samlClientIds,omitempty" tf:"saml_client_ids,omitempty"`
...
type ClientAdminPermissionsParameters struct {
...
type ClientAdminPermissionsSpec struct {
	...
	// autoscaler.
	InitProvider ClientAdminPermissionsInitParameters `json:"initProvider,omitempty"`
}
...
// ClientAdminPermissions is the Schema for the ClientAdminPermissionss API.
...
type ClientAdminPermissions struct {
	...
	Spec   ClientAdminPermissionsSpec   `json:"spec"`
	Status ClientAdminPermissionsStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// ClientAdminPermissionsList contains a list of ClientAdminPermissionss
type ClientAdminPermissionsList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []ClientAdminPermissions `json:"items"`
}

// Repository type metadata.
var (
	ClientAdminPermissions_Kind             = "ClientAdminPermissions"
	ClientAdminPermissions_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: ClientAdminPermissions_Kind}.String()
	ClientAdminPermissions_KindAPIVersion   = ClientAdminPermissions_Kind + "." + CRDGroupVersion.String()
	ClientAdminPermissions_GroupVersionKind = CRDGroupVersion.WithKind(ClientAdminPermissions_Kind)
)

func init() {
	SchemeBuilder.Register(&ClientAdminPermissions{}, &ClientAdminPermissionsList{})
}
