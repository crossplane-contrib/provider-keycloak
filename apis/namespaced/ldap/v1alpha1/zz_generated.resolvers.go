...
// ResolveReferences of this UserModelHardcodedAttributeMapper.
func (mg *UserModelHardcodedAttributeMapper) ResolveReferences(ctx context.Context, c client.Reader) error {
	var m xpresource.Managed
	var l xpresource.ManagedList
	r := reference.NewAPINamespacedResolver(c, mg)
