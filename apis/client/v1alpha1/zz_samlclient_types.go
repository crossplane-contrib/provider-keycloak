...
type SamlClientAuthenticationFlowBindingOverridesInitParameters struct {
...
type SamlClientAuthenticationFlowBindingOverridesObservation struct {
...
type SamlClientAuthenticationFlowBindingOverridesParameters struct {
...
type SamlClientInitParameters struct {
	...
	AuthenticationFlowBindingOverrides []SamlClientAuthenticationFlowBindingOverridesInitParameters `json:"authenticationFlowBindingOverrides,omitempty" tf:"authentication_flow_binding_overrides,omitempty"`
...
type SamlClientObservation struct {
	...
	// Override realm authentication flow bindings
	AuthenticationFlowBindingOverrides []SamlClientAuthenticationFlowBindingOverridesObservation `json:"authenticationFlowBindingOverrides,omitempty" tf:"authentication_flow_binding_overrides,omitempty"`
...
type SamlClientParameters struct {
	...
	// Override realm authentication flow bindings
	// +kubebuilder:validation:Optional
	AuthenticationFlowBindingOverrides []SamlClientAuthenticationFlowBindingOverridesParameters `json:"authenticationFlowBindingOverrides,omitempty" tf:"authentication_flow_binding_overrides,omitempty"`
...
type SamlClientSpec struct {
	...
	ForProvider     SamlClientParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider SamlClientInitParameters `json:"initProvider,omitempty"`
}

// SamlClientStatus defines the observed state of SamlClient.
type SamlClientStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        SamlClientObservation `json:"atProvider,omitempty"`
}
...
// SamlClientList contains a list of SamlClients
...
var (
	SamlClient_Kind             = "SamlClient"
	SamlClient_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: SamlClient_Kind}.String()
	SamlClient_KindAPIVersion   = SamlClient_Kind + "." + CRDGroupVersion.String()
	SamlClient_GroupVersionKind = CRDGroupVersion.WithKind(SamlClient_Kind)
)
