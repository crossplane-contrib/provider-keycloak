...
type ProtocolMapperInitParameters struct {
	...
	OidcClientIDRef *v1.Reference `json:"oidcClientIdRef,omitempty" tf:"-"`

	// Selector for a Client in openidclient to populate oidcClientId.
	// +kubebuilder:validation:Optional
	OidcClientIDSelector *v1.Selector `json:"oidcClientIdSelector,omitempty" tf:"-"`
	...
	// +kubebuilder:validation:Optional
	OidcClientScopeIDRef *v1.Reference `json:"oidcClientScopeIdRef,omitempty" tf:"-"`

	// Selector for a ClientScope in openidclient to populate oidcClientScopeId.
	// +kubebuilder:validation:Optional
	OidcClientScopeIDSelector *v1.Selector `json:"oidcClientScopeIdSelector,omitempty" tf:"-"`
	...
	// The ID of the client scope this protocol mapper should be added to. Conflicts with client_id. This argument is required if client_id is not set.
	// The mapper's associated client scope. Cannot be used at the same time as client_id.
	// +crossplane:generate:reference:type=github.com/crossplane-contrib/provider-keycloak/apis/samlclient/v1alpha1.ClientScope
