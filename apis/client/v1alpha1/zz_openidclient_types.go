...
type OpenIdClientInitParameters struct {
...
type OpenIdClientObservation struct {
...
type OpenIdClientParameters struct {
...
type OpenIdClientSpec struct {
	...
	ForProvider     OpenIdClientParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider OpenIdClientInitParameters `json:"initProvider,omitempty"`
}

// OpenIdClientStatus defines the observed state of OpenIdClient.
type OpenIdClientStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        OpenIdClientObservation `json:"atProvider,omitempty"`
}
...
type OpenIdClient struct {
	...
	Status OpenIdClientStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// OpenIdClientList contains a list of OpenIdClients
...
var (
	OpenIdClient_Kind             = "OpenIdClient"
	OpenIdClient_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: OpenIdClient_Kind}.String()
	OpenIdClient_KindAPIVersion   = OpenIdClient_Kind + "." + CRDGroupVersion.String()
	OpenIdClient_GroupVersionKind = CRDGroupVersion.WithKind(OpenIdClient_Kind)
)
