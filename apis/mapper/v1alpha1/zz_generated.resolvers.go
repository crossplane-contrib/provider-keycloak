...
import (
	...
	v1alpha13 "github.com/crossplane-contrib/provider-keycloak/apis/saml/v1alpha1"
...
// ResolveReferences of this SamlProtocolMapper.
func (mg *SamlProtocolMapper) ResolveReferences(ctx context.Context, c client.Reader) error {
	r := reference.NewAPIResolver(c, mg)
	...
	rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
		...
		To: reference.To{
			List:    &v1alpha13.ClientScopeList{},
			Managed: &v1alpha13.ClientScope{},
		},
	})
	if err != nil {
