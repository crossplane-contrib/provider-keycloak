...
func (tr *AudienceResolveProtocolMapper) GetObservation() (map[string]any, error) {
...
func (tr *AudienceResolveProtocolMapper) SetObservation(obs map[string]any) error {
...
func (tr *AudienceResolveProtocolMapper) GetParameters() (map[string]any, error) {
...
func (tr *AudienceResolveProtocolMapper) SetParameters(params map[string]any) error {
...
// GetInitParameters of this AudienceResolveProtocolMapper
func (tr *AudienceResolveProtocolMapper) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this AudienceResolveProtocolMapper
func (tr *AudienceResolveProtocolMapper) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
