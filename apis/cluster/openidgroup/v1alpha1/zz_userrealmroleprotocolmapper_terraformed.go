...
func (tr *UserRealmRoleProtocolMapper) GetObservation() (map[string]any, error) {
...
func (tr *UserRealmRoleProtocolMapper) SetObservation(obs map[string]any) error {
...
func (tr *UserRealmRoleProtocolMapper) GetParameters() (map[string]any, error) {
...
func (tr *UserRealmRoleProtocolMapper) SetParameters(params map[string]any) error {
...
// GetInitParameters of this UserRealmRoleProtocolMapper
func (tr *UserRealmRoleProtocolMapper) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this UserRealmRoleProtocolMapper
func (tr *UserRealmRoleProtocolMapper) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
