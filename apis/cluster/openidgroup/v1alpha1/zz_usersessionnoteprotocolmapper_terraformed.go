...
func (tr *UserSessionNoteProtocolMapper) GetObservation() (map[string]any, error) {
...
func (tr *UserSessionNoteProtocolMapper) SetObservation(obs map[string]any) error {
...
func (tr *UserSessionNoteProtocolMapper) GetParameters() (map[string]any, error) {
...
func (tr *UserSessionNoteProtocolMapper) SetParameters(params map[string]any) error {
...
// GetInitParameters of this UserSessionNoteProtocolMapper
func (tr *UserSessionNoteProtocolMapper) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this UserSessionNoteProtocolMapper
func (tr *UserSessionNoteProtocolMapper) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
