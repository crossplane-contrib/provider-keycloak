...
func (tr *UserClientRoleProtocolMapper) GetObservation() (map[string]any, error) {
...
func (tr *UserClientRoleProtocolMapper) SetObservation(obs map[string]any) error {
...
func (tr *UserClientRoleProtocolMapper) GetParameters() (map[string]any, error) {
...
func (tr *UserClientRoleProtocolMapper) SetParameters(params map[string]any) error {
...
// GetInitParameters of this UserClientRoleProtocolMapper
func (tr *UserClientRoleProtocolMapper) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this UserClientRoleProtocolMapper
func (tr *UserClientRoleProtocolMapper) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
