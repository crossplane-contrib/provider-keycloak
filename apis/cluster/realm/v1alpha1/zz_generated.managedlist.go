...
// GetItems of this ClientPolicyProfileList.
func (l *ClientPolicyProfileList) GetItems() []resource.Managed {
...
// GetItems of this ClientPolicyProfilePolicyList.
func (l *ClientPolicyProfilePolicyList) GetItems() []resource.Managed {
	items := make([]resource.Managed, len(l.Items))
	for i := range l.Items {
		items[i] = &l.Items[i]
	}
...
// GetItems of this ClientRegistrationPolicyList.
func (l *ClientRegistrationPolicyList) GetItems() []resource.Managed {
	items := make([]resource.Managed, len(l.Items))
	for i := range l.Items {
		items[i] = &l.Items[i]
	}
...
// GetItems of this DefaultClientScopesList.
func (l *DefaultClientScopesList) GetItems() []resource.Managed {
	items := make([]resource.Managed, len(l.Items))
	for i := range l.Items {
		items[i] = &l.Items[i]
	}
...
// GetItems of this OptionalClientScopesList.
func (l *OptionalClientScopesList) GetItems() []resource.Managed {
	items := make([]resource.Managed, len(l.Items))
	for i := range l.Items {
		items[i] = &l.Items[i]
	}
