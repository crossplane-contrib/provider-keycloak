...
type GenericClientRoleMapperParameters struct {
...
type GenericClientRoleMapperSpec struct {
	...
	// autoscaler.
	InitProvider GenericClientRoleMapperInitParameters `json:"initProvider,omitempty"`
}
...
// GenericClientRoleMapper is the Schema for the GenericClientRoleMappers API.
...
type GenericClientRoleMapper struct {
	...
	Spec              GenericClientRoleMapperSpec   `json:"spec"`
	Status            GenericClientRoleMapperStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// GenericClientRoleMapperList contains a list of GenericClientRoleMappers
type GenericClientRoleMapperList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []GenericClientRoleMapper `json:"items"`
}

// Repository type metadata.
var (
	GenericClientRoleMapper_Kind             = "GenericClientRoleMapper"
	GenericClientRoleMapper_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: GenericClientRoleMapper_Kind}.String()
	GenericClientRoleMapper_KindAPIVersion   = GenericClientRoleMapper_Kind + "." + CRDGroupVersion.String()
	GenericClientRoleMapper_GroupVersionKind = CRDGroupVersion.WithKind(GenericClientRoleMapper_Kind)
)

func init() {
	SchemeBuilder.Register(&GenericClientRoleMapper{}, &GenericClientRoleMapperList{})
}
