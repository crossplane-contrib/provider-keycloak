...
func (mg *HardcodedAttributeMapper) GetTerraformResourceType() string {
	return "keycloak_ldap_hardcoded_attribute_mapper"
}
...
// LateInitialize this HardcodedAttributeMapper using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *HardcodedAttributeMapper) LateInitialize(attrs []byte) (bool, error) {
	params := &HardcodedAttributeMapperParameters{}
