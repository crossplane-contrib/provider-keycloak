...
type UserModelHardcodedAttributeMapperParameters struct {
...
type UserModelHardcodedAttributeMapperSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     UserModelHardcodedAttributeMapperParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider UserModelHardcodedAttributeMapperInitParameters `json:"initProvider,omitempty"`
}
...
// UserModelHardcodedAttributeMapper is the Schema for the UserModelHardcodedAttributeMappers API.
// +kubebuilder:printcolumn:name="SYNCED",type="string",JSONPath=".status.conditions[?(@.type=='Synced')].status"
// +kubebuilder:printcolumn:name="READY",type="string",JSONPath=".status.conditions[?(@.type=='Ready')].status"
// +kubebuilder:printcolumn:name="EXTERNAL-NAME",type="string",JSONPath=".metadata.annotations.crossplane\\.io/external-name"
// +kubebuilder:printcolumn:name="AGE",type="date",JSONPath=".metadata.creationTimestamp"
// +kubebuilder:resource:scope=Cluster,categories={crossplane,managed,keycloak}
type UserModelHardcodedAttributeMapper struct {
	...
	Spec   UserModelHardcodedAttributeMapperSpec   `json:"spec"`
	Status UserModelHardcodedAttributeMapperStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// UserModelHardcodedAttributeMapperList contains a list of UserModelHardcodedAttributeMappers
type UserModelHardcodedAttributeMapperList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []UserModelHardcodedAttributeMapper `json:"items"`
}

// Repository type metadata.
var (
	UserModelHardcodedAttributeMapper_Kind             = "UserModelHardcodedAttributeMapper"
	UserModelHardcodedAttributeMapper_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: UserModelHardcodedAttributeMapper_Kind}.String()
	UserModelHardcodedAttributeMapper_KindAPIVersion   = UserModelHardcodedAttributeMapper_Kind + "." + CRDGroupVersion.String()
	UserModelHardcodedAttributeMapper_GroupVersionKind = CRDGroupVersion.WithKind(UserModelHardcodedAttributeMapper_Kind)
)

func init() {
	SchemeBuilder.Register(&UserModelHardcodedAttributeMapper{}, &UserModelHardcodedAttributeMapperList{})
}
