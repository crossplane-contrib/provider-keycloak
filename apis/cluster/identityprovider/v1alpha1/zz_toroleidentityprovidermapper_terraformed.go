...
func (tr *ToRoleIdentityProviderMapper) GetObservation() (map[string]any, error) {
...
func (tr *ToRoleIdentityProviderMapper) SetObservation(obs map[string]any) error {
...
func (tr *ToRoleIdentityProviderMapper) GetParameters() (map[string]any, error) {
...
func (tr *ToRoleIdentityProviderMapper) SetParameters(params map[string]any) error {
...
// GetInitParameters of this ToRoleIdentityProviderMapper
func (tr *ToRoleIdentityProviderMapper) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this ToRoleIdentityProviderMapper
func (tr *ToRoleIdentityProviderMapper) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
