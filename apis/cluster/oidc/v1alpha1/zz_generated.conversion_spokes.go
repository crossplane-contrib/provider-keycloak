...
// ConvertTo converts this IdentityProvider to the hub type.
func (tr *IdentityProvider) ConvertTo(dstRaw conversion.Hub) error {
...
// ConvertFrom converts from the hub type to the IdentityProvider type.
func (tr *IdentityProvider) ConvertFrom(srcRaw conversion.Hub) error {
	spokeVersion := tr.GetObjectKind().GroupVersionKind().Version
