...
type GithubIdentityProviderInitParameters struct {
	...
	GithubJSONFormat *bool `json:"githubJsonFormat,omitempty" tf:"github_json_format,omitempty"`
...
type GithubIdentityProviderObservation struct {
...
type GithubIdentityProviderParameters struct {
...
type GithubIdentityProviderSpec struct {
	...
	// autoscaler.
	InitProvider GithubIdentityProviderInitParameters `json:"initProvider,omitempty"`
}
...
// GithubIdentityProvider is the Schema for the GithubIdentityProviders API.
...
// GithubIdentityProviderList contains a list of GithubIdentityProviders
...
var (
	GithubIdentityProvider_Kind             = "GithubIdentityProvider"
	GithubIdentityProvider_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: GithubIdentityProvider_Kind}.String()
	GithubIdentityProvider_KindAPIVersion   = GithubIdentityProvider_Kind + "." + CRDGroupVersion.String()
	GithubIdentityProvider_GroupVersionKind = CRDGroupVersion.WithKind(GithubIdentityProvider_Kind)
)

func init() {
	SchemeBuilder.Register(&GithubIdentityProvider{}, &GithubIdentityProviderList{})
}
