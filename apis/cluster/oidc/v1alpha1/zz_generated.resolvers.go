...
func (mg *FacebookIdentityProvider) ResolveReferences( // ResolveReferences of this FacebookIdentityProvider.
...
// ResolveReferences of this GithubIdentityProvider.
func (mg *GithubIdentityProvider) ResolveReferences(ctx context.Context, c client.Reader) error {
	var m xpresource.Managed
	var l xpresource.ManagedList
	r := reference.NewAPIResolver(c, mg)
...
// ResolveReferences of this MicrosoftIdentityProvider.
func (mg *MicrosoftIdentityProvider) ResolveReferences(ctx context.Context, c client.Reader) error {
	var m xpresource.Managed
	var l xpresource.ManagedList
	r := reference.NewAPIResolver(c, mg)
