...
func SetupWebhookWithManager(mgr ctrl.Manager) error {
	if err := ctrl.NewWebhookManagedBy(mgr, &v1alpha1.KeystoreRsa{}).
		Complete(); err != nil {
...
// SetupGated adds a controller that reconciles KeystoreRsa managed resources.
func SetupGated(mgr ctrl.Manager, o tjcontroller.Options) error {
	o.Options.Gate.Register(func() {
		if err := Setup(mgr, o); err != nil {
			mgr.GetLogger().Error(err, "unable to setup reconciler", "gvk", v1alpha1.KeystoreRsa_GroupVersionKind.String())
		}
	}, v1alpha1.KeystoreRsa_GroupVersionKind)
	return nil
}
